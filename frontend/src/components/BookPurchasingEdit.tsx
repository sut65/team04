...
interface BookPurchasing {
  Cancle: () => void;
  Data: BookPurchasingInterface | undefined;
}

function EditBookPurchasing({ Cancle, Data }: BookPurchasing) {
...
export default EditBookPurchasing;
